<script>
  ...
  let company = {
    ...
    managers: ["john.doe@example.com", "jane.smith@example.com"],
  };

  // Food Baskets
  let foodBaskets = [
    { id: 1, name: "Vegetarian Basket", price: "15.99€", items: ["Vegetables", "Fruits"], availability: "In Stock" },
    { id: 2, name: "Mixed Basket", price: "12.99€", items: ["Bakery", "Dairy"], availability: "Limited Stock" },
  ];
...
<svelte:head>
  ...
  <meta name="description" content="Manage your company's account and food baskets on SaveTheBite." />
</svelte:head>
            ...
            <div class="border p-4 rounded-lg shadow-md">
              <div class="flex justify-between items-center">
                <div>
                  ...
                  <p class="text-gray-600">Availability: {basket.availability}</p>
                </div>
                <div class="space-x-2">
                  <button
